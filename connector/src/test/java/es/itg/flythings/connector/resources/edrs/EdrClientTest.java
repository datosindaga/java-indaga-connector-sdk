package es.itg.flythings.connector.resources.edrs;

import static org.junit.jupiter.api.Assertions.assertNotNull;

import com.fasterxml.jackson.databind.ObjectMapper;
import es.itg.flythings.auth.config.SdkConfig;
import es.itg.flythings.connector.resources.edrs.client.EDRCacheClient;
import es.itg.flythings.connector.resources.edrs.dto.EndpointDataReferenceDTO;
import es.itg.flythings.dataspace.edc.dto.CriterionDTO;
