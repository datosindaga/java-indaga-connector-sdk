package es.itg.flythings.dataspace.sdk;
...
/**
 * The type Download example.
 */
public class DownloadExample {

    private static final Logger log = Logger.getLogger(DownloadExample.class.getName());
    ...
    public static void main(String[] args) throws SdkBadRequestException, SdkServerException {
        ...
        var file = download.download(new DownloadRequest
            .Builder("a3fe7fee-b359-477c-ab9d-0f9671601bf4").build());
